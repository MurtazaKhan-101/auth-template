...
class ApiClient {
    ...
    async refreshAccessToken() {
        ...
        try {
            const response = await fetch(`${this.baseURL}${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].REFRESH_TOKEN}`, {
                method: "POST",
                credentials: "include",
                headers: {
                    ...
                    try {
                        ...
                        if (!retryResponse.ok) {
                            throw {
                                ...
                                message: retryData.message || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ERROR_MESSAGES"].GENERIC_ERROR,
                                data: retryData
                            };
                        }
                        return retryData;
    ...
    async logout() {
        try {
            ...
            await this.post(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].LOGOUT, {});
        } catch (error) {
...
const login = async (email, password)=>{
    try {
        ...
        if (response.success) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].setAccessToken(response.token);
...
const logout = async ()=>{
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].logout();
        ...
        clearUserData();
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].clearAccessToken();
        throw error;
    }
};
const isAuthenticated = ()=>{
    return !!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getAccessToken();
};
const initializeAuth = async ()=>{
    try {
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].refreshAccessToken();
...
const handleOAuthSuccess = (user, token)=>{
    // Store access token in memory and user data in localStorage
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].setAccessToken(token);
    saveUserData(user);
    return {
        success: true,
        user
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initAuth = async ()=>{
            try {
                ...
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeAuth"]();
    ...
    const logout = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logout"]();
            setUser(null);
            setIsAuthenticated(false);
            router.push(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ROUTES"].LOGIN);
        } catch (error) {
    ...
    const handleOAuthSuccess = (user, token)=>{
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["handleOAuthSuccess"](user, token);
        if (result.success) {
            setUser(result.user);
            setIsAuthenticated(true);
            return {
    ...
    const updateUser = (userData)=>{
        setUser(userData);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$auth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveUserData"](userData);
    };
    const value = {
        user,
        loading,
